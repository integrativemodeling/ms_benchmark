...
#        iD = r.add_type([rps[5]])
        ...
        n1 = r.add_composite([iG, iG, iG, iD, iDP, iCHI, iPSI])
        n2 = r.add_composite([iG, iG, iG], n1)
        n3 = r.add_composite([iG, iG], n2)

        n4 = r.add_composite([iG, iG, iG, iDP, iPSI, iCHI], n1)
        n5 = r.add_composite([iG, iG, iDP, iPSI, iCHI], n4)
        n6 = r.add_composite([iG, iG, iPSI, iCHI], n5)
        n7 = r.add_composite([iG, iG, iG, iPSI, iCHI], n4)



        n8 = r.add_composite([iG, iG, iG, iD, iDP], n1)
        n9 = r.add_composite([iG, iG, iG, iDP], n8)
        n10 = r.add_composite([iG, iG, iDP], n9)
        n11 = r.add_composite([iG, iDP], n10)
        n12 = r.add_composite([iD, iDP], n8)
...
f1 = open("out_scores_Large-clamp-upd15.csv", "w")
