...
for i in range(Na, Nb):
       InputFileName="mod-abcd-upd-v2."+str(i)+".mfj"
...
#              DDE = sqrt(pow(b[0][3]-b[0][4], 2) + pow(b[1][3]-b[1][4], 2) + pow(b[2][3]-b[2][4], 2))
              return DAB, DAC, DAD,  DBC, DBD, DCD
...
#              OvAE = (b[3][0]+b[3][4]-c[3])/(b[3][0]+b[3][4])
              OvBC = (b[3][1]+b[3][2]-c[3])/(b[3][1]+b[3][2])
              OvBD = (b[3][1]+b[3][3]-c[4])/(b[3][1]+b[3][3])
#              OvBE = (b[3][1]+b[3][4]-c[6])/(b[3][1]+b[3][4])
              OvCD = (b[3][2]+b[3][3]-c[5])/(b[3][2]+b[3][3])
#              OvCE = (b[3][2]+b[3][4]-c[8])/(b[3][2]+b[3][4])
#              OvDE = (b[3][3]+b[3][4]-c[9])/(b[3][3]+b[3][4])
              return OvAB, OvAC, OvAD,OvBC, OvBD,  OvCD
       ...
       def getScore(lines):
              if (d[0]<0.45) and (d[1]<0.45) and (d[2]<0.45) and (d[3]<0.45) and (d[4]<0.45) and (d[5]<0.45):
                     score1 = 0.0
              else:
                     score1 = 1.0
              ScoreTotal = score1
       ...
       SummaryFileName = 'out_overlap-abcd-upd-v2.csv'
