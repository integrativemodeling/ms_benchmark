...
for i in range(NA, NB):
       ...
       InputFileName="mod-aabc-ver2."+str(i)+".mfj"
       ...
       def getDiffs(lines, linkA, linkB, RA, RB):
              Diff1 = (sqrt(pow(b[0][linkA]-b[0][linkB], 2) + pow(b[1][linkA]-b[1][linkB], 2) + pow(b[2][linkA]-b[2][linkB], 2)))-(b[3][RA]+b[3][RB])*1.15
              return Diff1
...
#       list2.append(eDiff)
       ...
       SummaryFileName = 'out-score-AABC-ver2.csv'
