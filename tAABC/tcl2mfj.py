...
if not os.path.exists('output/mfj'):
    os.makedirs('output/mfj')
...
for i in range(Na, Nb):
    ...
    fileName = "output/tcl/configuration." + str(i) + ".tcl"
...
# def getMfj_file(Fname,strNA,lines):
    Fname = 'output/mfj/configuration.' + str(i) + '.mfj'
    f1 = open(Fname, 'w')
    #f1 = open(Fname, 'w')
    f1.write(os.path.basename(Fname) + '\n')
    # f1.write(strNM+'\n')
    f1.write('1' + '\n')
    f1.write(Nsphs + '\n')
    f1.write('ang' + '\n')
