...
for i in range(NA, NB):
       ...
       InputFileName="mod-11m."+str(i)+".mfj"
...
#       cL = getDistancesAs(ReadFile(InputFileName), posL1, posL2)
	...
	#print c
       ...
       list2 = [3, 4, 6, 7, 8, 9, 12, 13, 14, 15, 16, 17, 18, 20, 21, 22, 22, 24, 25, 26, 29, 30, 31, 32, 33, 35,36, 37, 28, 29, 40, 42, 43, 44, 45, 46, 47, 48, 50, 51, 54]
       ScoreNI = []
       for i in list2:
              SB= getScoreNonInteractions(list2, outDiff[i])
              ScoreNI.append(SB)
              SCNI = sum(ScoreNI)
       print SCNI
...
#       list2.append(eDiff)
       ...
       SummaryFileName = 'fraction-11m-up.csv'
